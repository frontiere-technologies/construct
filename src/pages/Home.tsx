...
export const Home: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold mb-6 capitalize">{location.pathname === '/' ? 'Dashboard' : location.pathname.substring(1).replace('/', ' - ')}</h1>
      ...
      <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 min-h-[400px]">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          This is a placeholder page for <strong>{location.pathname}</strong>. 
