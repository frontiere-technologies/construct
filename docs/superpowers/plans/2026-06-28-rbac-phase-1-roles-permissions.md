...
- [✅] **Step 1: Append types to `lib/rbac/types.ts`**
...
- [✅] **Step 1: Add the failing test** (append inside the existing `describe('mapNavigationToSidebar', …)` block in `sidebar-adapter.test.ts`)
...
- [✅] **Step 3: Add the orphan-drop pass**
...
- [✅] **Step 3: Implement `lib/rbac/permission-tree.ts`**
...
- [✅] **Step 1: Append `role_list_view` to `schema.sql`**
...
- [✅] **Step 2: Apply to remote DB and verify**
...
- [✅] **Step 3: Implement `lib/rbac/roles-service.ts`**
...
- [✅] **Step 1: Implement `lib/rbac/roles-actions.ts`**
...
- [✅] **Step 3: Verify the SERVICE/SYSTEM guards against the live DB**
...
- [✅] **Step 1: Implement `components/rbac/DataTable.tsx`**
...
- [✅] **Step 1: Implement `components/rbac/NavigationTree.tsx`**
...
- [✅] **Step 1: Implement `components/rbac/PermissionsTree.tsx`**
...
- [✅] **Step 3: `RolesTableClient.tsx`** (URL-driven state; the page re-renders on searchParam changes)
...
- [✅] **Step 4: `app/(protected)/rolesPermissions/page.tsx`**
...
- [✅] **Step 2: `app/(protected)/rolesPermissions/[roleId]/page.tsx`**
...
- [✅] **Step 1: Write `sources/tests/e2e/test_roles.py`**
